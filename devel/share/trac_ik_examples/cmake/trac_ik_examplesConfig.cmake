...
if("TRUE" STREQUAL "TRUE")
  set(trac_ik_examples_SOURCE_PREFIX /home/ravi/classic_ur_ws/src/track_ik/trac_ik_examples)
  set(trac_ik_examples_DEVEL_PREFIX /home/ravi/classic_ur_ws/devel)
  ...
  set(trac_ik_examples_INSTALL_PREFIX /home/ravi/classic_ur_ws/install)
...
if(NOT "/usr/include;/opt/ros/kinetic/share/orocos_kdl/../../include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'trac_ik_examples' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ravi/classic_ur_ws/src/track_ik/trac_ik_examples/${idir}'.  ${_report}")
    endif()
    _list_append_unique(trac_ik_examples_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/opt/ros/kinetic/lib/liborocos-kdl.so.1.3.2")
