...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6f().pack(_x.width, _x.speed, _x.acc, _x.force, _x.force_finger0, _x.force_finger1))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.width, _x.speed, _x.acc, _x.force, _x.force_finger0, _x.force_finger1,) = _get_struct_6f().unpack(str[start:end])
      return self
